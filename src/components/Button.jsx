...
const Button = ({ arrow = true, onClick, className, children }) => {
  return (
    <button
    onClick={onClick}
      className={twMerge(`not-first:uppercase relative tracking-widest px-4 mt-5 py-3 text-sm bg-gray-300 group z-0 cursor-pointer hover:text-white duration-300`, className)}
    >
      <span
