...
import { Phone, Clock, Mail, Facebook, Twitter, Instagram, Youtube, MessageCircle, ChevronUp } from 'lucide-react';
...
export default function Footer() {
  ...
  return (
    <footer className="bg-primary text-white py-16 px-4 relative">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <h2 className="text-4xl">Subrent</h2>
          </div>
          <p className="text-gray-300 text-lg">712 Jefferson Ave, Brooklyn</p>
