...
const features = [
  {
    ...
    description:
      "We manage your entire property with no hidden fees!***Nous gérons l'intégralité de votre bien sans frais cachés !",
    icon: <FaHandPeace />,
  },
  {
    title: "Profitability***Rentabilité",
    description:
      "Paying your rent every month is our number one commitment.***Le paiement, tous les mois, de votre loyer est notre engagement N°1",
    icon: <FaMoneyBillTrendUp />,
  },
  {
    title: "Flexibility***Flexibilité",
    description:
      "You can retrieve your property whenever you wish.***Vous pouvez récupérer votre bien quand vous le souhaitez.",
    icon: <FaSmile />,
  },
  {
    title: "Insurance***Assurance",
    description:
      "Your property is protected against damage with our insurance.***Votre bien immobilier est protégé avec notre assurance contre les dégradations.",
    icon: <FaNewspaper />,
  },
  {
    ...
    <section id="who-choose-us" className="section-y-padding bg-gray-100">
      <div className="default-width ">
        ...
        <motion.div
          ...
          className="grid sm:grid-cols-2 md:grid-cols-3 mt-12 bg-gray-500 gap-px p-px"
        >
