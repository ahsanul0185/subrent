  ...
  return (
    <div className="flex h-[65vh]">
      <div className="w-1/2 overflow-clip">
        <motion.img initial={{scale : 1.4}} whileInView={{scale : 1}} transition={{duration : 1.5, ease : [0.25, 1, 0.5, 1]}} viewport={{amount : 0.1, once : true}} src={img} className="w-full h-full object-cover" alt="" />
      </div>

<motion.div
  className="w-1/2 h-full bg-primary-dark py-16 px-12"
